...
void FUN_f2200098(undefined4 *param_1,undefined4 *param_2,int param_3)
...
void FUN_f22000b4(undefined4 *param_1,undefined4 param_2,int param_3)
...
/* @ 0xf22000ec -- WARNING: Could not recover jumptable at 0xf22000fc. Too many branches */
...
void FUN_f2200114(undefined4 param_1)
...
{
/* @ 0xf220011c -- WARNING: Could not recover jumptable at 0xf220011e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*DAT_f2200120)();
  return;
}
...

{
  ...
  if (iVar2 != 0) {
    FUN_f2201716(DAT_f2200294);
    goto LAB_f220019a;
  }
  iVar2 = FUN_f220437e(DAT_f220029c,pcVar4,local_80,&local_84);
  if (iVar2 != 0) {
    FUN_f2201716(DAT_f22002a0);
    local_84 = 0;
  }
  iVar2 = FUN_f22041ec(pcVar4,local_80,local_84 << 0x1c | 0xd,0xd,0,&local_88,auStack_78);
  if (iVar2 == 0) {
    if (local_88 < 0) goto LAB_f22001d8;
    iVar2 = FUN_f22044a0(pcVar4,local_68,0x1000000,0x1000,auStack_58);
    if (iVar2 != 0) {
      FUN_f2201716(DAT_f22002a8);
      goto LAB_f220019a;
    }
    (*pcVar4)(local_68 + 0x21000,&local_7c,4);
    (*pcVar4)(local_68 + 0x21004,0x1000000,local_7c);
    uVar5 = 0x1000000;
  }
  else {
    FUN_f2201716(DAT_f22002a4);
LAB_f22001d8:
    iVar2 = FUN_f22041ec(pcVar4,local_80,local_84 << 0x1c | 4,4,0,&local_88,auStack_78);
    if (iVar2 != 0) {
      FUN_f2201716(DAT_f22002a4);
      goto LAB_f220019a;
    }
    if (local_88 < 0) {
      FUN_f2201716(DAT_f22002b0);
      goto LAB_f220019a;
    }
    iVar2 = FUN_f2204394(pcVar4,local_68,auStack_58);
    if (iVar2 != 0) {
      FUN_f2201716(DAT_f22002b4);
      goto LAB_f220019a;
    }
    iVar2 = FUN_f2204430(pcVar4,local_68,local_28);
    uVar5 = local_20;
    if (iVar2 != 0) {
      FUN_f2201716(DAT_f22002b8);
      goto LAB_f220019a;
    }
  }
  FUN_f2201716(DAT_f22002ac);
  FUN_f22000ec(uVar5);
LAB_f220019a:
  do {
/* @ 0xf2200124 -- WARNING: Do nothing block with infinite loop */
  } while( true );
}
...

{
  ...
  iVar2 = FUN_f2203db0(DAT_f2200334,DAT_f2200338,*(int *)(iVar1 + 0x14) != DAT_f2200330,auStack_1c);
  if (((iVar2 == 0) && (iVar2 = FUN_f2203e18(auStack_1c,&uStack_25,auStack_24), iVar2 == 0)) &&
     (iVar2 = FUN_f2203ee8(auStack_1c,0,&local_20), iVar2 == 0)) {
...
void FUN_f2200340(uint param_1)

{
  *(uint *)(DAT_f2200358 + 4) = param_1;
  FUN_f2200114(param_1 >> 4);
...

{
  ...
  iVar1 = FUN_f22044d0(*(undefined1 *)(DAT_f22003a8 + 0x27),uVar2,7,DAT_f22003a4);
  if (iVar1 != 0) {
    FUN_f2201716(DAT_f22003ac);
    return;
  }
  return;
}
...

{
  ...
  iVar1 = FUN_f22044d0(*(undefined1 *)(DAT_f22003a8 + 0x27),uVar2 + 0xb,3,DAT_f22003a4 + 0xb);
  if (iVar1 != 0) {
    FUN_f2201716(DAT_f22003ac);
    return;
  }
...

{
  ...
  iVar1 = FUN_f22044d0(*(undefined1 *)(DAT_f22003a8 + 0x27),uVar2 + 0xe,0x16,DAT_f22003a4 + 0xe);
  if (iVar1 != 0) {
    FUN_f2201716(DAT_f22003ac);
    return;
  }
...

{
  ...
  iVar1 = FUN_f22044d0(*(undefined1 *)(DAT_f22003a8 + 0x27),uVar2 + 0x24,2,DAT_f22003a4 + 0x24);
  if (iVar1 != 0) {
    FUN_f2201716(DAT_f22003ac);
    return;
  }
...

{
  ...
  *(undefined8 *)(iVar3 + 8) = 0;
  FUN_f2200814();
  FUN_f22018f4(DAT_f22005ec,DAT_f22005e4,DAT_f22005e8,iVar13);
  *(uint *)(iVar13 + 0x6c) = *(uint *)(iVar8 + 4) / DAT_f22005f0;
  FUN_f220061c(iVar13 + 0x104);
  FUN_f2200628(DAT_f22005f4);
...
LAB_f2200448:
  ...
  FUN_f2200816(DAT_f22005f4,DAT_f2200600);
  FUN_f2200a58(*(undefined4 *)(iVar13 + 0x18),*(undefined4 *)(iVar13 + 0x14),DAT_f2200604);
  FUN_f2200d10(puVar14[9]);
  pcVar9 = (char *)*puVar14;
...
LAB_f220052c:
  ...
  *(undefined1 *)(iVar13 + 0x70) = uVar10;
  do {
    iVar16 = iVar16 + 1;
    iVar6 = FUN_f2201a90(iVar8);
    if (iVar6 == 0) {
      if (iVar16 != 1) {
        FUN_f2201716(DAT_f2200614,0,iVar16);
      }
      goto LAB_f22005be;
    }
  } while (iVar16 != 1000);
  FUN_f2201716(DAT_f2200610,0);
LAB_f22005be:
  if (iVar6 == 0) {
    uVar7 = *(uint *)(iVar3 + 8);
...
void FUN_f220061c(undefined4 *param_1)
...

{
  ...
  uVar2 = 0;
  do {
    FUN_f220093c(uVar2,&local_48,&local_44);
    if (local_48 == 0) {
      FUN_f2201716(DAT_f22007c4,DAT_f22007c0);
      return -0x13;
    }
    if (local_44 == 0) {
      iVar9 = 1;
    ...
    while (iVar3 = FUN_f22013e8(local_48,(int)((ulonglong)uVar1 /
      ...
      uVar6 = param_1[8];
      FUN_f2201716(DAT_f22007d0,DAT_f22007cc,uVar6);
      uVar7 = DAT_f22007dc;
      if ((((0x442 < uVar6) && (uVar7 = DAT_f22007f4, 0x4e2 < uVar6)) &&
          (uVar7 = DAT_f22007e4, 0x5dc < uVar6)) && (uVar7 = DAT_f22007e8, 0x753 < uVar6)) {
        iVar3 = -0x16;
        FUN_f2201716(DAT_f22007d4,DAT_f22007cc,uVar6);
        goto LAB_f22006d0;
      }
      FUN_f2201716(DAT_f22007d0,DAT_f22007e0,uVar7);
...
LAB_f22006f4:
        iVar3 = -0x16;
        FUN_f2201716(DAT_f22007ec,DAT_f22007e0,uVar7);
LAB_f2200702:
        FUN_f2201716(DAT_f22007f0,DAT_f22007cc);
LAB_f22006d0:
        FUN_f2201716(DAT_f22007d8,DAT_f22007c0);
        return iVar3;
      }
      uVar8 = 3;
      uVar2 = 0x11;
LAB_f2200732:
      iVar3 = FUN_f2203db0(DAT_f22007f8,0,1,auStack_3c);
      uVar4 = DAT_f22007fc;
      if (((iVar3 != 0) ||
          (iVar3 = FUN_f2203e50(auStack_3c,uVar2,1000), uVar4 = DAT_f2200800, iVar3 != 0)) ||
         (iVar3 = FUN_f2203f50(auStack_3c,0,uVar8,0,0,1,1000), uVar4 = DAT_f2200804, iVar3 != 0)) {
        FUN_f2201716(uVar4,DAT_f22007e0);
        goto LAB_f2200702;
      }
      FUN_f2200100(40000);
      FUN_f2200340(uVar7);
...
void FUN_f2200816(undefined4 *param_1,undefined1 *param_2)

{
  ...
  for (; (int)uVar5 < 0xd; uVar5 = uVar5 + 1) {
...
void FUN_f220093c(int param_1,undefined4 *param_2,undefined4 *param_3)

{
    ...
    *pcVar4 = 'T';
    ...
    if (*pcVar6 == -0x56) {
      ...
      *(ushort *)(pcVar4 + 6) = CONCAT11(cVar1,pcVar6[5]);
      ...
      FUN_f2201716(DAT_f2200a34);
      FUN_f2201716(DAT_f2200a38);
      puVar9 = extraout_r2;
      uVar3 = DAT_f2200a54;
      pcVar4 = DAT_f2200a30;
    }
  ...
  while( true ) {
    if (0x58 < *piVar5) {
      FUN_f2201716(DAT_f2200a3c);
      *param_2 = 0;
      *param_3 = 0;
      return;
    }
    FUN_f2201716(uVar3,*pcVar4,puVar9,*piVar5,param_1,puVar11);
    uVar10 = DAT_f2200a44;
    uVar8 = DAT_f2200a50;
    if ((*pcVar4 != '\0') &&
       (iVar7 = FUN_f22044d0(*pcVar4,*(undefined2 *)(pcVar4 + 2),0x100,DAT_f2200a44),
       uVar8 = DAT_f2200a48, iVar7 == 0)) break;
    FUN_f2201716(uVar8);
    FUN_f2201716(DAT_f2200a4c);
    iVar7 = *piVar5;
    *pcVar4 = (char)iVar7;
    pcVar4[2] = '\0';
    pcVar4[3] = '\0';
  ...
  if ((pcVar4[4] == '\0') ||
     (iVar7 = FUN_f22044d0(pcVar4[4],*(undefined2 *)(pcVar4 + 6),1,&stack0xffffffdf), iVar7 != 0)) {
    *param_2 = uVar10;
    uVar10 = 0;
  }
  else {
...
void FUN_f2200a58(uint param_1,uint param_2,undefined1 *param_3)

{
  ...
  *param_3 = 1;
  ...
  if (param_1 < 2) {
    ...
    *(undefined2 *)(param_3 + 0xe) = 10;
    *(undefined2 *)(param_3 + 0x12) = 10;
    *(undefined2 *)(param_3 + 0x18) = 1;
    *(undefined2 *)(param_3 + 0x10) = 5;
    *(undefined2 *)(param_3 + 0x14) = 4;
    *(undefined2 *)(param_3 + 0x16) = 8;
  ...
  *(undefined2 *)(param_3 + 10) = 0x707;
  ...
  iVar7 = 0;
  do {
    if (*(char *)(iVar6 + iVar7 * 2) == local_36[iVar4 * 10 + iVar8 * 5]) {
      param_3[1] = *(undefined1 *)(iVar6 + iVar7 * 2 + 1);
      goto LAB_f2200b9c;
    }
    iVar7 = iVar7 + 1;
  } while (iVar7 != 10);
  FUN_f2201716(DAT_f2200cec,DAT_f2200ce8);
LAB_f2200b9c:
  cVar1 = local_36[iVar4 * 10 + iVar8 * 5 + 1];
  iVar6 = 0;
  if (cVar1 == '\0') {
LAB_f2200bea:
    ...
    FUN_f2201716(DAT_f2200cf8,DAT_f2200ce8);
  }
  cVar1 = local_36[iVar4 * 10 + iVar8 * 5 + 2];
  if (cVar1 == '\x06') {
    iVar6 = 0;
LAB_f2200c30:
    *param_3 = *(undefined1 *)(DAT_f2200cfc + iVar6 * 2 + 1);
    ...
    FUN_f2201716(DAT_f2200cf4,DAT_f2200ce8);
  }
  iVar6 = 0;
  do {
    if (*(char *)(DAT_f2200d00 + iVar6 * 2) == local_36[iVar4 * 10 + iVar8 * 5 + 3]) {
      bVar2 = true;
  ...
  bVar2 = false;
  FUN_f2201716(DAT_f2200d08,DAT_f2200ce8);
LAB_f2200c62:
  iVar6 = 0;
  do {
  ...
  FUN_f2201716(DAT_f2200d0c,DAT_f2200ce8);
  bVar3 = false;
LAB_f2200c8a:
  if (bVar2) {
    param_3[0x1e] = uVar9;
...
void FUN_f2200d10(undefined1 param_1)

{
  ...
  if (*(char *)(iVar2 + 0xb) == -0x45) {
    ...
    if (uVar4 != 0xff) {
      ...
      case 1:
      case 4:
        FUN_f2201716(DAT_f2200dbc);
      case 0:
        iVar2 = 1;
        break;
      case 5:
        FUN_f2201716(DAT_f2200dc8);
      default:
        iVar2 = 2;
      }
      uVar7 = uVar4 & 7;
...
uint FUN_f2200dcc(byte *param_1,int param_2)
...
undefined4 FUN_f2200df8(int param_1,uint param_2,undefined4 param_3,undefined4 param_4)
        ...
        if (param_2 < 0x4e2) {
          if (param_2 < 0x42e) {
            if (param_2 < 0x3a7) {
              if (param_2 < 0x341) {
                if (param_2 < 0x2ee) {
                  FUN_f2201716(DAT_f2200e70,DAT_f2200e6c,param_3,0x2ed,param_4);
                  return 0xfffffffb;
                }
                uVar1 = 0xc;
              }
...
undefined4 FUN_f2200e74(int param_1,uint param_2,undefined4 param_3,undefined4 param_4)
    ...
    if (param_2 < 0x42e) {
      if (param_2 < 0x3a7) {
        if (param_2 < 0x341) {
          if (param_2 < 0x2ee) {
            if (param_2 < 0x2a9) {
              FUN_f2201716(DAT_f2200ed4,DAT_f2200ed0,param_3,0x2ed,param_4);
              return 0xfffffffb;
            }
            uVar1 = 0x10;
          }
...
undefined4 FUN_f2200ed8(int param_1,uint param_2,int param_3,uint param_4)

{
  ...
  if (uVar1 == 0x20) {
    FUN_f2201716(DAT_f2200f28,DAT_f2200f24,0x20,param_4,param_4);
  }
  else {
    ...
    FUN_f2201716(DAT_f2200f2c,DAT_f2200f24,uVar1,uVar1 * param_4,param_4);
  }
  return 0xfffffffb;
}
...
int FUN_f2200f30(int param_1,uint param_2,int *param_3,undefined4 *param_4)
  ...
  if ((*(byte *)(param_1 + 7) & 7) != 0) {
    ...
    *(uint *)(puVar2 + 4) = ((*(byte *)(param_1 + 7) & 0x3f) >> 3) + 1;
    ...
    if (bVar6 == 2) {
      ...
      if (bVar6 != 1) {
        FUN_f2201716(DAT_f2201130,DAT_f2201124);
        return -0x16;
      }
      uVar7 = 2;
    }
    ...
    *(undefined4 *)(puVar2 + 0x10) = 0;
    ...
    if ((uVar5 & 0xf) < 0xe) {
      ...
      *(uint *)(puVar2 + 0x14) = (uint)((bVar1 & 0x18) != 0);
      ...
      param_3[7] = uVar5;
      uVar5 = uVar8 * *(byte *)(param_1 + 0xc) + (int)((int)*(char *)(param_1 + 0x22) * uVar5) / 10;
      param_3[8] = uVar5;
      if ((param_2 < uVar5) && (FUN_f2201716(DAT_f220112c), param_4 != (undefined4 *)0x0)) {
        *param_4 = 1;
        return 0;
      }
      iVar3 = FUN_f2200ed8(param_3,(uint)*(ushort *)(param_1 + 0xe) << 4,
                           param_3[6] * (uint)*(byte *)(param_1 + 0x10) +
                           ((int)*(char *)(param_1 + 0x23) * param_3[7]) / 10,param_2);
      uVar4 = DAT_f2201138;
      if ((iVar3 == 0) && (iVar3 = FUN_f2200df8(param_3,param_2), uVar4 = DAT_f220113c, iVar3 == 0))
      {
        iVar9 = param_3[1];
        iVar10 = param_3[6];
        *(uint *)(iVar9 + 0x34) = iVar10 * (uint)*(byte *)(param_1 + 0x11);
        iVar3 = param_3[7];
        *(uint *)(iVar9 + 0x14) =
             iVar10 * (uint)*(byte *)(param_1 + 0x12) + (iVar3 * *(char *)(param_1 + 0x24)) / 10;
        iVar10 = param_3[6];
        *(uint *)(iVar9 + 0x18) = iVar10 * (uint)*(byte *)(param_1 + 0x13);
        *(uint *)(iVar9 + 0x1c) =
             iVar10 * (uint)*(byte *)(param_1 + 0x14) + (iVar3 * *(char *)(param_1 + 0x25)) / 10;
        bVar1 = *(byte *)(param_1 + 0x15);
        iVar10 = param_3[6];
        *(uint *)(iVar9 + 0xc) = iVar10 * ((bVar1 & 0xf) << 8 | (uint)*(byte *)(param_1 + 0x16));
        *(uint *)(iVar9 + 0x10) =
             iVar10 * ((bVar1 & 0xf0) << 4 | (uint)*(byte *)(param_1 + 0x17)) +
             (*(char *)(param_1 + 0x26) * iVar3) / 10;
        ...
        *(uint *)(iVar9 + 8) =
             param_3[6] * ((*(byte *)(param_1 + 0x1c) & 0xf) << 8 | (uint)*(byte *)(param_1 + 0x1d))
        ;
        param_3[9] = (uint)*(byte *)(param_1 + 6);
        return 0;
      }
      FUN_f2201716(uVar4,DAT_f2201124);
      return iVar3;
    }
  }
LAB_f2200f46:
  FUN_f2201716(uVar4,uVar5);
  return -0x16;
}
...
int FUN_f2201140(int param_1,int param_2,int *param_3,undefined4 *param_4)
...
switchD_f2201156_default:
      FUN_f2201716(uVar3,DAT_f22013c4);
      return -0x16;
    }
    uVar7 = 2;
  }
  ...
  if ((uVar4 & 0xf) < 0xe) {
    ...
    *(uint *)(puVar2 + 0x14) = (uint)((bVar1 & 0x18) != 0);
    ...
    if (uVar4 == 0) {
      ...
      param_3[8] = uVar4;
      if ((param_2 + 1U < uVar4) && (FUN_f2201716(DAT_f22013e0), param_4 != (undefined4 *)0x0)) {
        *param_4 = 1;
        return 0;
      }
      iVar9 = FUN_f2200ed8(param_3,((uint)*(byte *)(param_1 + 0x15) << 8 |
                                    (uint)*(byte *)(param_1 + 0x15) << 0x10 |
                                   (uint)*(byte *)(param_1 + 0x14)) << 7,
                           param_3[6] * (uint)*(byte *)(param_1 + 0x18) +
                           ((int)*(char *)(param_1 + 0x7b) * param_3[7]) / 10,param_2);
      uVar3 = DAT_f22013c8;
      if ((iVar9 == 0) && (iVar9 = FUN_f2200e74(param_3,param_2), uVar3 = DAT_f22013e4, iVar9 == 0))
      {
        iVar5 = param_3[7];
        iVar10 = param_3[1];
        iVar9 = param_3[6];
        *(uint *)(iVar10 + 0x44) =
             iVar9 * (uint)*(byte *)(param_1 + 0x28) + (iVar5 * *(char *)(param_1 + 0x75)) / 10;
        *(uint *)(iVar10 + 0x14) =
             iVar9 * (uint)*(byte *)(param_1 + 0x19) + (iVar5 * *(char *)(param_1 + 0x7a)) / 10;
        *(uint *)(iVar10 + 0x48) =
             iVar9 * (uint)*(byte *)(param_1 + 0x26) + (iVar5 * *(char *)(param_1 + 0x77)) / 10;
        *(uint *)(iVar10 + 0x18) =
             iVar9 * (uint)*(byte *)(param_1 + 0x27) + (iVar5 * *(char *)(param_1 + 0x76)) / 10;
        *(uint *)(iVar10 + 0x1c) =
             iVar9 * (uint)*(byte *)(param_1 + 0x1a) + (iVar5 * *(char *)(param_1 + 0x79)) / 10;
        bVar1 = *(byte *)(param_1 + 0x1b);
        iVar9 = param_3[6];
        *(uint *)(iVar10 + 0xc) = iVar9 * ((bVar1 & 0xf) << 8 | (uint)*(byte *)(param_1 + 0x1c));
        *(uint *)(iVar10 + 0x10) =
             iVar9 * ((bVar1 & 0xf0) << 4 | (uint)*(byte *)(param_1 + 0x1d)) +
             (*(char *)(param_1 + 0x78) * iVar5) / 10;
        ...
        *(uint *)(iVar10 + 8) =
             param_3[6] * ((*(byte *)(param_1 + 0x24) & 0xf) << 8 | (uint)*(byte *)(param_1 + 0x25))
        ;
        param_3[9] = (uint)*(byte *)(param_1 + 0xb);
        FUN_f22017a4(iVar9 + 0x20,param_1 + 0x3c,8);
        FUN_f22017a4(*param_3 + 0x28,param_1 + 0x46,8);
        FUN_f22017a4(*param_3 + 0x30,param_1 + 0x44,2);
...
int FUN_f22013e8(char *param_1,undefined4 param_2,int *param_3,undefined4 *param_4)

{
  ...
  puVar5 = param_4;
  uVar1 = FUN_f2200dcc(param_1,uVar3,param_3,(int)*param_1,param_4);
  uVar4 = (uVar1 & 0xffff) >> 8;
  uVar3 = DAT_f22014a8;
  if (((uint)(byte)param_1[0x7e] == (uVar1 & 0xff)) && ((byte)param_1[0x7f] == uVar4)) {
    uVar1 = FUN_f2200dcc(param_1 + 0x80,0x7e,(uint)(byte)param_1[0x7f],uVar4,puVar5);
    uVar3 = DAT_f22014a8;
    if (((uint)(byte)param_1[0xfe] == (uVar1 & 0xff)) &&
       ((uint)(byte)param_1[0xff] == (uVar1 & 0xffff) >> 8)) {
      if (param_1[2] == '\v') {
        *(undefined1 *)(*param_3 + 0x18) = 0;
        iVar2 = FUN_f2200f30(param_1,param_2,param_3,param_4);
        uVar3 = DAT_f22014a4;
      }
      else {
        uVar3 = DAT_f22014b0;
        if (param_1[2] != '\f') goto LAB_f220146c;
        *(undefined1 *)(*param_3 + 0x18) = 1;
        iVar2 = FUN_f2201140(param_1,param_2,param_3,param_4);
        uVar3 = DAT_f22014ac;
      }
      if (iVar2 == 0) {
        return 0;
      }
      FUN_f2201716(uVar3,DAT_f22014a0);
      return iVar2;
    }
  }
LAB_f220146c:
...
/* @ 0xf22014c8 -- WARNING: Removing unreachable block (ram,0xf2201746) */
...
uint FUN_f22014dc(uint param_1)

{
  FUN_f220178c(0,param_1 & 0xff);
  if (param_1 == 10) {
    FUN_f220178c(0,0xd);
  }
  return param_1;
...
void FUN_f220150a(uint param_1,int param_2,uint param_3,int param_4,char *param_5,uint param_6,
                 uint param_7)
...
uint FUN_f220159c(undefined1 *param_1,uint param_2)
...
undefined4 FUN_f22015e4(undefined1 param_1)
...
void FUN_f2201618(undefined4 param_1,uint param_2,byte *param_3,uint *param_4)
...
LAB_f22016cc:
    ...
    uVar4 = 0;
LAB_f22016dc:
    iVar1 = FUN_f220150a(*param_4,uVar4,uVar6,bVar8,auStack_28,bVar5,uVar3);
    puVar2 = auStack_28;
LAB_f22016ec:
    param_4 = param_4 + 1;
    FUN_f220159c(puVar2,iVar1);
  } while( true );
}
...
void FUN_f2201716(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  uStack_8 = param_3;
  uStack_4 = param_4;
  FUN_f2201618(0,0xffffffff,param_1,&uStack_c,param_1,&uStack_c,param_3);
  return;
}
...
void FUN_f220178c(int param_1,undefined4 param_2)
...
undefined4 * FUN_f22017a4(undefined4 *param_1,undefined4 *param_2,uint param_3,undefined4 param_4)
    ...
    for (; param_1 = puVar1, puVar2 = param_2, param_3 != 0; param_3 = param_3 - 1) {
      if (((uint)puVar1 & 3) == 0) {
        if (0x1f < (int)param_3) {
          ...
          FUN_f2200098(puVar1,param_2,iVar4,param_2,param_4);
        }
...
void FUN_f220180e(uint *param_1,uint param_2,uint param_3)

{
  ...
  if (0x1f < (int)param_3) {
    iVar1 = (int)param_3 >> 5;
    param_3 = param_3 & 0x1f;
    FUN_f22000b4(param_1,uVar3,iVar1);
...
undefined4 FUN_f220186a(uint *param_1,uint param_2,uint param_3,int param_4)
...
int FUN_f2201894(int param_1,int param_2,int param_3,undefined4 param_4)

{
  ...
  iVar2 = *(int *)(param_1 + 4);
  iVar1 = FUN_f220186a(iVar2 + 0x18,1,0,5000);
  if (iVar1 == 0) {
    *(uint *)(iVar2 + 0x10) =
         ((param_3 << 0xc | param_2 << 4) ^ *(uint *)(iVar2 + 0x10)) & 0xf0f1 ^
         *(uint *)(iVar2 + 0x10);
    *(undefined4 *)(iVar2 + 0x14) = param_4;
    *(uint *)(iVar2 + 0x10) = ~*(uint *)(iVar2 + 0x10) & 0x80000000 ^ *(uint *)(iVar2 + 0x10);
  }
  else {
    FUN_f2201716(DAT_f22018f0,DAT_f22018ec);
  }
  return iVar1;
}
...
undefined4 FUN_f22018f4(undefined4 param_1,undefined4 param_2,int *param_3,undefined4 *param_4)
  ...
  *param_4 = param_1;
  ...
  if (iVar2 == DAT_f2201930) {
    ...
    if (iVar2 != DAT_f2201934) {
      FUN_f2201716(DAT_f220193c,DAT_f2201938,iVar2,param_4,param_4);
      FUN_f2201716(DAT_f2201944,DAT_f2201940,0xd15);
      return 0xfffffffb;
    }
    uVar1 = 2;
  }
...
undefined4 FUN_f2201968(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  FUN_f2201716(DAT_f220199c,DAT_f2201998,param_3,uVar1,param_4);
  return 0xffffff60;
}
...
undefined4 FUN_f22019a0(int param_1)

{
  ...
  FUN_f2201716(DAT_f22019f0,DAT_f22019ec);
  return 0xffffff60;
}
...
void FUN_f22019f4(int param_1,uint param_2,undefined4 param_3)
...
undefined4 FUN_f2201a10(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
  ...
  if (cVar1 == '\x01') {
    ...
    *(uint *)(iVar2 + 0xc) = ~*(uint *)(iVar2 + 0xc) & 0x4000000 ^ *(uint *)(iVar2 + 0xc);
    while (-1 < *(int *)(iVar2 + 0x1c) << 1) {
      ...
      if (iVar3 == 0) {
LAB_f2201a74:
        FUN_f2201716(DAT_f2201a8c,DAT_f2201a84);
        return 0xffffff60;
      }
      FUN_f2204518(1);
    }
    ...
    if (cVar1 != '\x02') {
      FUN_f2201716(DAT_f2201a88,DAT_f2201a84,cVar1,param_4,param_4);
      return 0xffffffea;
    }
    iVar3 = 0x1389;
...
LAB_f2202248:
  ...
  *puVar40 = *puVar40 ^
  ...
  puVar40[0x35] =
       puVar40[0x35] ^
       (puVar40[0x35] ^ ((((iVar44 + 999U) / 1000 + 0x3ff >> 10) + 1 >> 1) + 1) * 0x10000) &
       0xff0000;
  uVar24 = param_1[0x29];
  uVar14 = DAT_f2202464;
  if (cVar2 == '\0') {
    if (9 < uVar24 - 5) goto switchD_f220308a_default;
...
switchD_f220308a_default:
  ...
  *(short *)(param_1 + 0x4d) = (short)local_160;
  ...
  puVar40[0x41] =
       ...
       puVar40[0x41];
  puVar40[0x42] =
       ((local_118 + iVar39 + 7 >> 1 | (iVar23 + 9U >> 1) << 8 | (iVar43 + 1U >> 1) << 0x10 |
        ((uint)(iVar39 + 1 + local_140) >> 1) << 0x18) ^ puVar40[0x42]) & 0x3f3f1f3f ^ puVar40[0x42]
  ;
  puVar40[0x43] =
...
LAB_f2202e96:
  ...
  if (*(byte *)((int)param_1 + 0x65) == 0xff) {
    ...
    uVar8 = *(byte *)((int)param_1 + 0x65) - 10;
  }
  ...
  puVar40[0x81] =
       puVar40[0x81] ^ ((iVar43 << 8 | iVar5 << 0x10 | uVar51) ^ puVar40[0x81]) & 0x1f1f1f;
  puVar40[0x82] =
       puVar40[0x82] ^
  ...
  *(uint *)(iVar42 + 0x4820) =
  ...
  puVar40[0x91] =
       ...
       (uint)*(ushort *)((int)param_1 + 0xc6) << 8 | (uint)uVar3 << 4 |
  ...
  *(uint *)(iVar42 + 0xa8) =
  ...
  puVar40[0x94] =
       DAT_f2202d48 & ((puVar55[2] << 8 | puVar55[1] << 0x18 | uVar8) ^ puVar40[0x94]) ^
       puVar40[0x94];
  ...
  *(undefined4 *)(iVar42 + 0x4830) = 0x61e;
  *(undefined4 *)(iVar42 + 0x4834) = 0xc;
  *(undefined4 *)(iVar42 + 0x4838) = 0x79e;
  *(undefined4 *)(iVar42 + 0x483c) = 0x70c;
  ...
  *(uint *)(iVar39 + 0x680) = *(uint *)(iVar39 + 0x680) & 0xffffc7ff;
  ...
  while( true ) {
    if ((char)iVar43 == '\0') {
      ...
      uVar14 = DAT_f22030c4;
      if (10 < uVar24) goto switchD_f220308a_default;
      ...
      *(uint *)(iVar46 + 0x684) =
           (((uint)pbVar48[2] << 0xc | (uint)*pbVar48 << 8 | (uint)pbVar48[4] << 0x10 |
            iVar5 << 0x16) ^ uVar37) & uVar35 ^ uVar37;
    }
    pbVar48 = pbVar48 + 1;
    if (iVar5 != 0) break;
    iVar5 = 1;
  ...
  *(uint *)(iVar39 + 0xc4) =
       ((uVar35 << 9 | 0x100) ^ *(uint *)(iVar39 + 0xc4)) & 0x7f00 ^ *(uint *)(iVar39 + 0xc4);
  uVar35 = DAT_f2203528;
  *(uint *)(iVar39 + 0x11c) =
  ...
  if (param_1[0x39] == 0) {
    ...
    do {
      ...
      for (uVar8 = 0; uVar35 != uVar8; uVar8 = uVar8 + 1) {
        ...
        *(undefined4 *)(iVar43 + 0x780) = 0x320032;
      }
      iVar42 = iVar42 + 1;
    } while (iVar42 != 9);
    FUN_f2201948(param_1);
  }
  uVar35 = DAT_f2203538;
  uVar8 = DAT_f2203534;
  ...
  *(uint *)(iVar42 + 0x1b0) = ~*(uint *)(iVar42 + 0x1b0) & 1 ^ *(uint *)(iVar42 + 0x1b0);
  ...
  if ((param_1[7] != 0) && ((char)param_1[10] == '\x01')) {
    FUN_f2204518(10);
    if ((((char)param_1[0x19] == -1) && (iVar39 = FUN_f2201894(param_1,1,7,0x88), iVar39 != 0)) ||
       ((param_1[8] != 0 && (iVar39 = FUN_f2201894(param_1,1,7,0xd8), iVar39 != 0)))) {
      FUN_f2201716(DAT_f2203540,DAT_f220353c);
      return iVar39;
    }
    *(uint *)(iVar42 + 0x10) = *(uint *)(iVar42 + 0x10) & 0xfffffff7;
  }
  FUN_f2201968(param_1);
  ...
  FUN_f220180e(local_98,0,0x24);
  FUN_f220180e(local_70,0,0x24);
  iVar42 = param_1[1];
  iVar39 = param_1[2];
  ...
  *(uint *)(iVar42 + 0x180) = ~*(uint *)(iVar42 + 0x180) & 0x80000000 ^ *(uint *)(iVar42 + 0x180);
  ...
  FUN_f2204518(5);
  FUN_f2201a10(param_1);
  iVar42 = FUN_f22019f4(param_1[2],0,0xe01);
  uVar14 = DAT_f2203a38;
  if (iVar42 == 0) {
LAB_f2203642:
    uVar36 = 0;
    ...
    do {
      if ((1 << (uVar36 & 0xff) & uVar8) >> (uVar36 & 0xff) != 0) {
        ...
        *(uint *)(iVar39 + 0x204) =
        ...
        iVar42 = FUN_f22019f4(iVar42,0,0x10001);
      ...
      do {
        ...
        *pcVar34 = '\0';
        if ((char)iVar18 != '\0') {
          ...
          *(undefined4 *)(iVar18 + 0x750) = 0x20202020;
          *(undefined4 *)(iVar18 + 0x754) = 0x20202020;
...
LAB_f22037d6:
      ...
      *(uint *)(iVar43 + 0x10) = ~*(uint *)(iVar43 + 0x10) & 0x4000000 ^ *(uint *)(iVar43 + 0x10);
      iVar42 = FUN_f22019f4(iVar42,0,0xc01);
      local_160 = 0;
      local_158 = local_164;
      do {
        if ((char)*local_158 != '\0') {
              ...
              if ((1 << (uVar36 & 0xff) & uVar35) >> (uVar36 & 0xff) != 0) {
                *(uint *)(iVar43 + 0x4dc) = uVar36 | uVar36 << 0x10;
                ...
                if (uVar37 < 0x20) {
                  ...
                  if (uVar19 == 0) {
                    iVar42 = -5;
                    FUN_f2201716(DAT_f2203a34,local_160);
                  }
                ...
                if (uVar51 < 0x20) {
                  ...
                  if (local_15c == 0) {
                    iVar42 = -5;
                    FUN_f2201716(DAT_f2203a30,local_160);
                  }
...

{
  ...
  *param_2 = uVar4;
  ...
  uVar4 = uVar5;
  if ((((!bVar6) &&
       (uVar7 = (uVar1 & 0x7ff) >> 9, uVar5 = DAT_f2203d40, uVar4 = DAT_f2203d18, uVar7 != 2)) &&
      (uVar5 = DAT_f2203d44, uVar7 != 3)) && (uVar5 = DAT_f2203d18, uVar7 == 0)) {
    uVar5 = DAT_f2203d48;
  }
  param_2[3] = uVar5;
  uVar3 = 1;
  param_2[4] = uVar4;
  *(byte *)(param_2 + 6) = (byte)((uVar1 << 0x14) >> 0x1f);
  uVar7 = (uVar1 & 0x3fff) >> 0xc;
  param_2[0xb] = 1;
  if (uVar7 == 2) {
    uVar2 = 0;
  }
  ...
  *(undefined1 *)((int)param_2 + 0x1a) = uVar2;
  *(byte *)((int)param_2 + 0x1b) = (byte)((uVar1 << 0x11) >> 0x1f);
  uVar7 = (uVar1 & 0x3ffff) >> 0xf;
  if (uVar7 == 7) {
    uVar5 = 0x1c200;
    uVar3 = 3;
  }
  else {
    uVar3 = *(undefined1 *)(DAT_f2203d1c + uVar7);
    uVar5 = *(undefined4 *)(DAT_f2203d20 + uVar7 * 4);
  }
  *(undefined1 *)(param_2 + 7) = uVar3;
  param_2[8] = uVar5;
  *(byte *)(param_2 + 9) = (byte)((uVar1 << 0xd) >> 0x1f);
  uVar7 = (uVar1 & 0x3fffff) >> 0x14;
  uVar3 = 1;
  if (uVar7 != 1) {
    if (uVar7 == 3) {
      uVar3 = 2;
  ...
  *(undefined1 *)((int)param_2 + 0x25) = uVar3;
  *(byte *)((int)param_2 + 0x26) = (byte)((uVar1 << 9) >> 0x1f);
  if ((uVar1 & 0x800000) == 0) {
    uVar3 = 0x50;
  }
  else {
  ...
  *(undefined1 *)((int)param_2 + 0x27) = uVar3;
...
void FUN_f2203d90(int param_1,uint param_2,uint param_3)
...
undefined4 FUN_f2203db0(undefined4 param_1,undefined4 param_2,int param_3,undefined4 *param_4)

{
  ...
  *param_4 = param_1;
  ...
  if (param_3 == 1) {
    ...
    if (param_3 != 2) {
      FUN_f2201716(DAT_f2203e14,DAT_f2203e10);
      return 0xffffffea;
    }
...
undefined4 FUN_f2203e50(int *param_1,uint param_2,int param_3,undefined4 param_4)

{
  ...
  if (param_1[3] == iVar4) {
    FUN_f2201716(DAT_f2203edc,DAT_f2203ee0,param_2,iVar4,param_4);
    uVar1 = 0xffffffea;
  }
  else {
LAB_f2203e80:
    ...
    *puVar3 = uVar5 | 0x80000000;
    ...
    if (iVar6 < 0) {
      ...
      FUN_f2201716(DAT_f2203ee4,DAT_f2203ee0,iVar4,iVar6,param_4);
      uVar1 = 0xffffffc4;
    }
  }
  return uVar1;
...
undefined4 FUN_f2203ee8(int *param_1,uint param_2,uint *param_3)
  ...
  *param_3 = 0;
  ...
  if (iVar1 != 0) {
    ...
    if ((uVar4 & 0x3ff) == 0) {
      ...
      FUN_f2201716(DAT_f2203f4c,DAT_f2203f48);
      uVar3 = 0xfffffffb;
    }
    else {
...
undefined4
FUN_f2203f50(undefined4 *param_1,undefined4 param_2,uint param_3,int param_4,int param_5,int param_6
            ,int param_7)

{
  ...
  if ((param_3 & 0xfffffc00) == 0) {
    ...
    FUN_f2203d90(*param_1,param_2,param_3 | 0x1000);
    if (param_6 != 0) {
      FUN_f2203d90(*param_1,extraout_r1,param_3 | 0x3000);
      FUN_f2204518(3);
      for (; (iVar2 = FUN_f2203d7e(*param_1), iVar2 == 0 && (param_7 != 0)); param_7 = param_7 + -1)
      {
        FUN_f2204518(1);
      }
      iVar2 = FUN_f2203d7e(*param_1);
      if (iVar2 == 0) {
        FUN_f2201716(DAT_f2203fe0,DAT_f2203fd8);
        return 0xffffffc4;
      }
    }
    uVar1 = 0;
    ...
    FUN_f2201716(DAT_f2203fdc,DAT_f2203fd8,param_3,0x3ff);
    uVar1 = 0xffffffea;
  }
  return uVar1;
}
...
int FUN_f2203ff8(code *param_1,int param_2,uint param_3,int param_4,undefined4 param_5,uint param_6,
                undefined4 *param_7)

{
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == local_2c) {
      ...
      if (iVar2 != 0) goto LAB_f22040f4;
      if (local_74 == iVar5) {
        FUN_f22017a4(param_7,&local_70,0x48);
        *param_7 = local_70;
        param_7[1] = local_6c;
        param_7[2] = local_68;
        param_7[3] = local_64;
      ...
      FUN_f2201716(DAT_f2204104,DAT_f2204100);
    }
    iVar2 = -5;
  }
  else {
LAB_f22040f4:
    FUN_f2201716(DAT_f2204108,DAT_f2204100);
  }
  return iVar2;
}
...
int FUN_f220410c(code *param_1,int param_2,int *param_3,uint *param_4)
  ...
  if (iVar1 == 0) {
    ...
    if ((local_54[0] == DAT_f22041a4) && (iVar1 = FUN_f2203fe4(local_54,0x10), iVar1 == local_44)) {
      ...
      *param_3 = local_4c * 0x20 + 0x18;
      ...
      FUN_f2201716(DAT_f22041ac,DAT_f22041a8);
    }
    iVar1 = -5;
  }
  else {
LAB_f2204194:
    FUN_f2201716(DAT_f22041b0,DAT_f22041a8);
  }
  return iVar1;
}
...

{
  ...
  while( true ) {
    ...
    iVar1 = FUN_f220410c(param_1,param_2,&uStack_20,&iStack_1c);
    if (iVar1 == 0) break;
...
int FUN_f22041ec(code *param_1,int param_2,int param_3,int param_4,uint param_5,uint *param_6,
                int *param_7)
...
LAB_f22042b0:
    FUN_f2201716(DAT_f22042c0,DAT_f22042bc);
  }
  return iVar2;
}
...
int FUN_f22042c4(int param_1,int param_2,code *param_3,int param_4,uint *param_5,uint *param_6)
  ...
  if ((uVar2 & 1) == 0) {
    ...
    if (iVar1 == 0) {
      ...
      for (iVar3 = 0; iVar3 != local_54; iVar3 = iVar3 + 1) {
        ...
        if ((((local_48[0] & 0xfffffff) == 1) || ((local_48[0] & 0xfffffff) - 0xc < 2)) &&
           (local_38 == uVar2)) {
      ...
      iVar1 = -0x16;
      FUN_f2201716(DAT_f2204364,DAT_f2204360,uVar2);
    }
    else {
LAB_f2204354:
      FUN_f2201716(DAT_f2204368,DAT_f2204360);
    }
  }
  else {
    iVar1 = 0;
...
int FUN_f2204394(code *param_1,undefined4 param_2,int *param_3)
  ...
  if (iVar1 == 0) {
    ...
    if (iVar2 == local_14) {
      if (local_58 == DAT_f2204424) {
        FUN_f22017a4(param_3,&local_58,0x48);
        *param_3 = local_58;
        param_3[1] = local_54;
        param_3[2] = local_50;
        param_3[3] = local_4c;
      ...
      FUN_f2201716(DAT_f2204428,DAT_f220441c);
      FUN_f2201716(DAT_f220442c,iVar1,local_58);
    }
    iVar1 = -5;
  }
  else {
    FUN_f2201716(DAT_f2204420,DAT_f220441c);
  }
  return iVar1;
}
...
int FUN_f2204430(code *param_1,int param_2,undefined4 param_3)

{
  ...
  if (iVar1 == 0) {
    ...
    if ((iVar1 == 0) && (iVar1 = (*param_1)(param_2 + 0x48 + local_38,&local_64), iVar1 == 0)) {
      ...
      FUN_f2201716(DAT_f2204498,DAT_f2204494);
      return -5;
    }
  }
  FUN_f2201716(DAT_f220449c,DAT_f2204494);
  return iVar1;
}
...
{
  FUN_f2203ff8(param_1,param_2,0x20000,0x21000,param_3,param_4,param_5,param_4);
  return;
}
...
void FUN_f22044d0(undefined4 param_1,uint param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  iVar1 = FUN_f2204694(auStack_28,DAT_f2204514,DAT_f2204510);
  if (iVar1 == 0) {
    FUN_f22046fc(auStack_28,param_1,uVar2,local_2c,param_3,param_4);
  }
  return;
}
...
void FUN_f2204518(uint param_1)
...
undefined4 FUN_f2204574(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  while (iVar1 = (uint)*(ushort *)(iVar4 + 0x34) << 0x16, -1 < iVar1) {
    if ((uint)param_1[1] < uVar2) {
      uVar3 = 0xffffff60;
      FUN_f2201716(DAT_f22045f0,DAT_f22045ec);
      goto LAB_f2204588;
    }
    uVar2 = uVar2 + 1;
...
LAB_f2204592:
    ...
    if ((uint)param_1[1] < uVar2) {
      uVar3 = 0xffffff60;
      FUN_f2201716(DAT_f22045f4,DAT_f22045ec);
      goto LAB_f2204592;
    }
    uVar2 = uVar2 + 1;
...
/* @ 0xf2204660 -- WARNING: Removing unreachable block (ram,0xf2204620) */
/* WARNING: Removing unreachable block (ram,0xf2204630) */

undefined4 FUN_f2204660(int *param_1,ushort param_2,byte *param_3,int param_4)
  ...
  *(ushort *)(iVar3 + 0x6c) = *(ushort *)(iVar3 + 0x6c) & 0xfffe | 1;
  ...
  do {
    ...
    while( true ) {
      ...
      if ((uint)param_1[1] < uVar2) {
        FUN_f2201716(DAT_f220465c,DAT_f2204658);
        return 0xffffff60;
      }
      uVar2 = uVar2 + 1;
...
undefined4 FUN_f2204694(int *param_1,char *param_2,ushort *param_3)
...
int FUN_f22046fc(int *param_1,undefined2 param_2,undefined4 param_3,undefined4 param_4,int param_5,
                undefined1 *param_6)

{
  ...
  iVar5 = *param_1;
  iVar1 = FUN_f2204660(param_1,param_2,param_4,param_3);
  iVar2 = param_5;
  iVar6 = param_5;
  if (iVar1 != 0) {
    return iVar1;
